...
#define MAX_USERS 1000  // constante que define número máximo de usuários
...
Usuario usuarios[MAX_USERS];        // array de usuários com o tamanho da constante

// declaração e inicialização da variável que rastreia a quantidade atual de usuários
int numUsuarios = 0;      
...
void cadastrarUsuario() {
    ...
    // para verificar se o numero máximo de usuários foi atingido
    ...
    // adiciona o novo usuário ao vetor e incrementa no contador de usuários
